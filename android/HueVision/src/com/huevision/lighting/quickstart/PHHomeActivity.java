...
import com.huevision.lighting.data.AccessPointListAdapter;
import com.huevision.lighting.data.HueSharedPreferences;
import com.huevision.lighting.quickstart.MainActivity;
...
public class PHHomeActivity extends Activity implements OnItemClickListener {
    ...
    private PHSDKListener listener = new PHSDKListener() {
        ...
        public void onBridgeConnected(PHBridge b) {
            ...
            PHWizardAlertDialog.getInstance().closeProgressDialog();     
            startMainActivity();
            Log.d("tabs", "startMainActivity called");
